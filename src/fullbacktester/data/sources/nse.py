"""NSE India official end-of-day bhavcopy. Optional dependency: ``pip install fullbacktester[nse]``.
...
from fullbacktester.markets import INDIA, Frequency, Market
...
class NSEBhavcopySource(DataSource):
    ...
    def _download(self, session: date) -> str | None:
        try:
            ...
            raise ImportError(
                "requests is not installed; run: pip install 'fullbacktester[nse]'"
            ) from exc
